...
::: {#cell-9 .cell outputId='42720a6e-85d0-4383-b4f4-f1d88650aaf1' execution_count=4}
``` {.python .cell-code}
data.describe()
```
...
::: {#cell-11 .cell outputId='3c0eb01e-d6db-4cac-a478-73c72198117e' execution_count=5}
``` {.python .cell-code}
data.isna().sum()
```
...
::: {#cell-13 .cell outputId='c2f7ab94-a366-4ab4-ddc4-7c2d40fdbbfa' execution_count=6}
``` {.python .cell-code}
sns.histplot(data=data, x="BloodPressure", kde=True)
```

::: {.cell-output .cell-output-display}
![](cod004_sol1_NeuralNetwork_files/figure-html/cell-7-output-1.png){}
:::
:::


::: {#cell-14 .cell outputId='da520703-144b-4e7b-f095-4a85e9091a46' execution_count=7}
``` {.python .cell-code}
sns.countplot(data=data, x="Outcome")
```

::: {.cell-output .cell-output-display}
![](cod004_sol1_NeuralNetwork_files/figure-html/cell-8-output-1.png){}
:::
:::
...
::: {#cell-16 .cell outputId='87b9e807-d100-4671-9275-37f2bdab50e5' execution_count=9}
``` {.python .cell-code}
sns.countplot(data=data, x="Outcome")
```

::: {.cell-output .cell-output-display}
![](cod004_sol1_NeuralNetwork_files/figure-html/cell-10-output-1.png){}
:::
:::
...
::: {#cell-23 .cell outputId='002a2215-da00-41de-f422-8677306d391f' execution_count=15}
``` {.python .cell-code}
...
::: {#cell-27 .cell execution_count=17}
``` {.python .cell-code}
...
::: {#cell-28 .cell execution_count=18}
``` {.python .cell-code}
red = RedNeuronal(8, 1)
...
::: {#cell-29 .cell execution_count=19}
``` {.python .cell-code}
...
::: {#cell-30 .cell execution_count=20}
``` {.python .cell-code}
criterio = nn.BCELoss()
...
::: {#cell-31 .cell execution_count=21}
``` {.python .cell-code}
