...
## 5. De cortes bidimensionales a un volumen tridimensional (idea práctica)

Hay dos escenarios conceptuales comunes:

**Escenario A (didáctico y muy usado para entender):** reconstruir muchos cortes bidimensionales independientes, cada uno con su sinograma, y luego apilarlos según la coordenada axial. Esto produce un volumen tridimensional.

**Escenario B (más fiel a muchos escáneres modernos):** reconstrucción verdaderamente tridimensional desde geometría de cono (con detector bidimensional). Allí se usan algoritmos de retroproyección filtrada adaptados a cono (por ejemplo, el método de Feldkamp–Davis–Kress) o métodos iterativos tridimensionales.

En docencia conviene dominar el escenario A primero, porque te obliga a entender el sinograma, el filtrado y la retroproyección sin una sobrecarga geométrica.

---

## 6. Ejemplo 2: reconstrucción tridimensional didáctica por apilamiento de cortes
...
## 7. De volumen a representación tridimensional: dos rutas útiles
...
## 8. Ejemplo 3 (opcional): malla interactiva en HTML con Plotly
...
## 9. Flujo con datos clínicos reales: lectura de serie en formato DICOM y volumen
...
### 9.1. Visualización rápida de cortes ortogonales del volumen real
...
## 10. Qué significa “reconstrucción tridimensional” en un escáner real
...
## 11. Lista de verificación para tu propio tutorial (lo que no debe faltar)
...
## 2. Materiales, datos y procedimiento
...
## 3. Reconstrucción bidimensional
...
## 5. Reconstrucción tridimensional y ensamblaje de volumen
...
## 6. Segmentación y visualización tridimensional
...
## 7. Métricas y evaluación cuantitativa
...
## 8. Discusión, conclusiones y reproducibilidad
