...
\bfseries\large{SEMESTRE: \MakeUppercase{$year$} -- \MakeUppercase{$period$}}\\[2em]
...
%
\begin{description}
  \item[Tiempo Permitido:] {\bfseries \MakeUppercase{$timeallowed$}}
  \item[Material Permitido:] {\bfseries \MakeUppercase{$openorclosed$}}\\
  $permitted$
  \item[Instrucciones:] 
  $instructions$
\end{description}
