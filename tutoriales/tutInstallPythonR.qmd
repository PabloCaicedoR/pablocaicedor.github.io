...
# 0 Instalación de Debian en WSL
...
3. **Instalar Debian**:
    ...
    - **O desde Microsoft Store**:
      ...
      2. Busca "Debian GNU/Linux" y pulsa **Instalar**.


5. **Primer arranque de Ubuntu**:
    1. Abre Debian desde el menú Inicio o Windows Terminal.
...
- Debian en WSL2 sobre Windows 11.
- Conexión a Internet.
- Permisos de sudo en la distribución Debian.
