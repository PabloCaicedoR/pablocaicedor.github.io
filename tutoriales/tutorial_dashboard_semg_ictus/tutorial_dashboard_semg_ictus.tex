...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, arc=.35mm, titlerule=0mm, bottomrule=.15mm, coltitle=black, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Solicitud clínica}, opacitybacktitle=0.6, breakable, bottomtitle=1mm, leftrule=.75mm, left=2mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame]
...
{\centering \includegraphics[width=0.96\linewidth,height=\textheight,keepaspectratio]{figuras/pipeline_semg.png}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, arc=.35mm, titlerule=0mm, bottomrule=.15mm, coltitle=black, opacityback=0, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia metodológica}, opacitybacktitle=0.6, breakable, bottomtitle=1mm, leftrule=.75mm, left=2mm, colback=white, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame]
...
\subsection{Información clínica del
participante}\label{informaciuxf3n-cluxednica-del-participante}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, arc=.35mm, titlerule=0mm, bottomrule=.15mm, coltitle=black, opacityback=0, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Punto de verificación}, opacitybacktitle=0.6, breakable, bottomtitle=1mm, leftrule=.75mm, left=2mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, toptitle=1mm, colframe=quarto-callout-important-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, arc=.35mm, titlerule=0mm, bottomrule=.15mm, coltitle=black, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Decisión de ingeniería}, opacitybacktitle=0.6, breakable, bottomtitle=1mm, leftrule=.75mm, left=2mm, colback=white, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, toptitle=1mm, colframe=quarto-callout-tip-color-frame]
...
Novak, Vera. 2018. {«Cerebral Vasoregulation in Elderly with Stroke»}.
PhysioNet, version 1.0.0. \url{https://doi.org/10.13026/C2DW96}.

\bibitem[\citeproctext]{ref-novak2010}
Novak, Vera, Kun Hu, Laura Desrochers, Peter Novak, Louis Caplan, Lewis
Lipsitz, y Magdy Selim. 2010. {«Cerebral flow velocities during daily
activities depend on blood pressure in patients with chronic ischemic
infarctions»}. \emph{Stroke} 41 (1): 61-66.
\url{https://doi.org/10.1161/STROKEAHA.109.565556}.

\bibitem[\citeproctext]{ref-wang2025}
Wang, Yong, Lingling Zhong, Minxia Jin, Dantong Liao, Adam J. Privitera,
Arnold Y. L. Wong, Gabriel C. H. Fong, Shi-Chun Bao, y Rui Sun. 2025.
{«Assessing stroke-induced abnormal muscle coactivation in the upper
limb using the surface EMG co-contraction Index: A systematic review»}.
\emph{Journal of Electromyography and Kinesiology} 81: 102985.
