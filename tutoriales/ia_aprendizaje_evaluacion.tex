...
\title{\texorpdfstring{Aprendizaje y evaluación en la era de la
IA}{Aprendizaje y evaluación en la era de la IA}}
\subtitle{\texorpdfstring{Herramientas, ejemplos y prompts para rediseño
evaluativo}{Herramientas, ejemplos y prompts para rediseño evaluativo}}
...
\protect\phantomsection\label{cambio-1-aprender-ya-no-es-solo-acceder-a-informaciuxf3n}
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Antes\ldots{}}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

Memorizar, recuperar, explicar y entregar.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-caution-color!10!white, colframe=quarto-callout-caution-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Ahora\ldots{}}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

Interrogar, verificar, contextualizar, decidir y defender.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Riesgo}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\protect\phantomsection\label{tres-niveles-de-impacto-sobre-el-aprendizaje}
...
\protect\phantomsection\label{rendimiento-aparente}
...
\protect\phantomsection\label{y-el-estudiante-que}
...
\protect\phantomsection\label{principio-de-diseuxf1o-del-aprendizaje}
...
\protect\phantomsection\label{la-pregunta-ya-no-es-usuxf3-ia}
...
\protect\phantomsection\label{evaluaciuxf3n-vulnerable-vs.-evaluaciuxf3n-resiliente}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
...
\protect\phantomsection\label{problema-matemuxe1tico-inicial}
...
\protect\phantomsection\label{momento-1-respuesta-correcta}
Una IA responde:
...
\protect\phantomsection\label{pregunta}
¿Esta respuesta demuestra que el estudiante aprendió?
\end{block}
\end{frame}

\begin{frame}{Discusión individual}
\protect\phantomsection\label{discusiuxf3n-individual}
...
\protect\phantomsection\label{momento-2-rendimiento-aparente}
...
\protect\phantomsection\label{pregunta-clave}
\begin{quote}
...
\protect\phantomsection\label{mini-diagnuxf3stico-de-vulnerabilidad}
...
\protect\phantomsection\label{trabajo-en-parejas}
...
\protect\phantomsection\label{preguntas}
\begin{enumerate}
\tightlist
\item
...
\protect\phantomsection\label{variaciuxf3n-del-problema}
...
\protect\phantomsection\label{evidencia-requerida}
...
\protect\phantomsection\label{bituxe1cora-muxednima-de-trazabilidad}
...
\protect\phantomsection\label{defensa-breve}
...
\protect\phantomsection\label{cierre-conceptual}
...
\protect\phantomsection\label{transiciuxf3n-hacia-aias}
...
\protect\phantomsection\label{pregunta-final}
\begin{quote}
...
\protect\phantomsection\label{para-tener-en-cuenta-al-rediseuxf1ar-la-evaluaciuxf3n}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{la-evaluaciuxf3n-formativa-gana-centralidad}
...
\protect\phantomsection\label{aias-declarar-niveles-de-uso-de-ia}
...
\protect\phantomsection\label{regla-de-oro-para-rediseuxf1ar}
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, breakable, colback=white, colframe=quarto-callout-color-frame, left=2mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, toprule=.15mm]
...
\protect\phantomsection\label{criterios-muxednimos-de-validez}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}ll@{}}
\toprule\noalign{}
...
\protect\phantomsection\label{herramienta-1-portafolio-con-trazabilidad}
...
\protect\phantomsection\label{herramienta-2-defensa-oral-breve}
...
\protect\phantomsection\label{herramienta-3-simulaciones-y-desempeuxf1o-en-vivo}
...
\protect\phantomsection\label{herramienta-4-ruxfabricas-analuxedticas-asistidas-por-ia}
...
\protect\phantomsection\label{herramienta-5-banco-de-preguntas-generadas-y-auditadas}
...
explícitos}
\protect\phantomsection\label{herramienta-6-revisiuxf3n-por-pares-con-criterios-expluxedcitos}
...
\protect\phantomsection\label{herramienta-7-auditoruxeda-de-salidas-de-ia}
...
\protect\phantomsection\label{herramienta-8-matriz-de-alineaciuxf3n}
...
\protect\phantomsection\label{ejemplo-1-ensayo-acaduxe9mico-rediseuxf1ado}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
...
\protect\phantomsection\label{ejemplo-2-proyecto-de-ciencia-de-datos}
...
\protect\phantomsection\label{ejemplo-3-programaciuxf3n}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}ll@{}}
\toprule\noalign{}
Evidencia & Criterio \\
...
\protect\phantomsection\label{ejemplo-4-evaluaciuxf3n-cluxednica-o-biomuxe9dica}
...
\protect\phantomsection\label{ejemplo-5-evaluaciuxf3n-de-fuentes-con-doi}
Tarea:
...
\protect\phantomsection\label{ejemplo-6-debate-tuxe9cnico-con-dossier}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}lll@{}}
\toprule\noalign{}
...
aprendizaje}
\protect\phantomsection\label{prompt-1-alinear-evaluaciuxf3n-con-resultados-de-aprendizaje}
\begin{quote}
...
\protect\phantomsection\label{prompt-2-crear-ruxfabrica-analuxedtica}
\begin{quote}
...
\protect\phantomsection\label{prompt-3-convertir-una-tarea-vulnerable-en-resiliente}
\begin{quote}
...
\protect\phantomsection\label{prompt-4-diseuxf1ar-defensa-oral}
\begin{quote}
...
\protect\phantomsection\label{prompt-5-generar-banco-de-preguntas-con-validaciuxf3n}
\begin{quote}
...
\protect\phantomsection\label{prompt-6-construir-una-bituxe1cora-de-ia}
\begin{quote}
...
\protect\phantomsection\label{prompt-7-auditar-una-respuesta-de-ia}
\begin{quote}
...
\protect\phantomsection\label{prompt-8-diseuxf1ar-evaluaciuxf3n-por-simulaciuxf3n}
\begin{quote}
...
\protect\phantomsection\label{prompt-9-crear-matriz-de-alineaciuxf3n}
\begin{quote}
...
\protect\phantomsection\label{prompt-10-generar-retroalimentaciuxf3n-formativa}
\begin{quote}
