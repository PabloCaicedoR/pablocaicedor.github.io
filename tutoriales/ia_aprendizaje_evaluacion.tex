...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-color-frame, bottomrule=.15mm, left=2mm, toprule=.15mm, colback=white, breakable, leftrule=.75mm, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Antes\ldots{}}, colframe=quarto-callout-warning-color-frame, titlerule=0mm, bottomrule=.15mm, colback=white, coltitle=black, opacitybacktitle=0.6, rightrule=.15mm, arc=.35mm, leftrule=.75mm, left=2mm, toprule=.15mm, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, opacityback=0]

Memorizar, recuperar, explicar y entregar.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Ahora\ldots{}}, colframe=quarto-callout-caution-color-frame, titlerule=0mm, bottomrule=.15mm, colback=white, coltitle=black, opacitybacktitle=0.6, rightrule=.15mm, arc=.35mm, leftrule=.75mm, left=2mm, toprule=.15mm, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-caution-color!10!white, toptitle=1mm, opacityback=0]

Interrogar, verificar, contextualizar, decidir y defender.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Riesgo}, colframe=quarto-callout-important-color-frame, titlerule=0mm, bottomrule=.15mm, colback=white, coltitle=black, opacitybacktitle=0.6, rightrule=.15mm, arc=.35mm, leftrule=.75mm, left=2mm, toprule=.15mm, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colframe=quarto-callout-note-color-frame, titlerule=0mm, bottomrule=.15mm, colback=white, coltitle=black, opacitybacktitle=0.6, rightrule=.15mm, arc=.35mm, leftrule=.75mm, left=2mm, toprule=.15mm, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, opacityback=0]
