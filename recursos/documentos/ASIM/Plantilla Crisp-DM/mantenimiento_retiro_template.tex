...
\section*{Mantenimiento y Retiro}
\subsection*{Retraining}
Criterio de activaci\'on, datos y frecuencia: \todo{Definir.}

\subsection*{Auditor\'ia}
Trazabilidad de versiones y accesos: \todo{Definir.}

\subsection*{Retiro seguro}
Plan de sustituci\'on y archivo de modelos: \todo{Definir.}
\signatureline
