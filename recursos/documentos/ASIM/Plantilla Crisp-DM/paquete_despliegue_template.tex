...
\section*{Paquete de Despliegue}
\subsection*{Estrategia}
Contenedor \, | \, wheel \, | \, servicio.

\subsection*{Infraestructura}
CPU/GPU, RAM, almacenamiento: \todo{Detallar.}

\subsection*{Integraci\'on}
API/HL7/DICOM, autenticaci\'on: \todo{Detallar.}

\subsection*{Rollback}
Versi\'on estable y procedimiento: \todo{Detallar.}
\signatureline
