...
\section*{Monitoreo y Respuesta a Incidentes}
\subsection*{KPIs en producci\'on}
Latencia, tasa de error, drift, desempe\~no: \todo{Definir.}

\subsection*{Alertas}
Umbrales y canal (email/ops): \todo{Definir.}

\subsection*{Runbooks}
Pasos ante fallo de modelo/datos/infra: \todo{Definir.}
\signatureline
